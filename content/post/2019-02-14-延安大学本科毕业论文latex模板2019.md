...
![封面页](http://image.i-ll.cc/blog/20190214/7xUqY1aI0UlI.png)

**声明页:**

![声明页](http://image.i-ll.cc/blog/20190214/GmUG6niVGzYY.png)
...
- 安装
    ...
    Windows 用户右键单击 install-tl-advanced.bat, 以管理员权限执行; ![安装](http://image.i-ll.cc/blog/20190214/VSAujx6AcK8I.png) 按照上图所示选择好之后点击"安装 TeXLive", 接下来等就是了.
...
TeXstudio有很多按钮, 无需记住太多命令就可上手, 输入数学公式比较方便,比较适合小白. 如下图所示: ![TeXstudio界面](http://image.i-ll.cc/blog/20190214/061opnbrvOqo.png)
...
- 配置
    ...
    ![TexStudio配置](http://image.i-ll.cc/blog/20190214/rGuUhFMUQEJq.png) 选中Commands, 设置成如下配置:
    
    ![命令设置](http://image.i-ll.cc/blog/20190214/3T7iDNvBBUL9.png)
...
![VScode界面](http://image.i-ll.cc/blog/20190214/9PFX385kxDp6.png)
...
- 插件配置
    ...
    点击左下角->settings,搜索`latex-workshop.latex.recipes`. 点击`Edit setttings.json`. ![vscode](http://image.i-ll.cc/blog/20190214/jObJi1ifByoT.png)
...
4. 根据中文说明进行填空;
5. 点击下图所示按钮编译并查看. ![TexStudioBuild](http://image.i-ll.cc/blog/20190214/TfYcA3BXBIlH.png)
...
5. 根据中文说明进行填空;
6. 点击下图选项; ![VScode1](http://image.i-ll.cc/blog/20190214/ITrDJ6W2WxRK.png)
7. 点击Build LaTeX project;
8. 点开View LaTeX PDF->View in VSCode tap 如下图所示. ![VScode2](http://image.i-ll.cc/blog/20190214/JjAJ7BoBHw3o.png)
